  ...
  return (
      <div className="border-4 border-slate-200 bg-white rounded-lg shadow-lg p-8 max-w-sm lg:max-w-lg mx-auto overflow-hidden">
        ...
        <form className="flex flex-col space-y-4" onSubmit={handleFormSubmission}>
          {/* Firstname Field */}
          <label htmlFor="firstname" className="text-slate-600 font-medium text-sm">
            Firstname
          </label>
          <input
              type="text"
          ...
          {/* Lastname Field */}
          <label htmlFor="lastname" className="text-slate-600 font-medium text-sm">
            Lastname
          </label>
          <input
              type="text"
          ...
          {/* Username Field */}
          <label htmlFor="username" className="text-slate-600 font-medium text-sm">
            Username
          </label>
          <input
              type="text"
